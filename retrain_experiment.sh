python main.py -p Toy --train --seed 12
python main.py -p Toy --train --seed 5
python main.py -p Toy --train --seed 4
python main.py -p Toy --train --seed 0
...
python main.py -p Seattle --train
python main.py -p Pacific --train 
python main.py -p Electricity --train
python table_generation.py --train